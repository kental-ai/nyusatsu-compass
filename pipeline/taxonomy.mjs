...
export const TAXONOMY = [
  ...
  { slug: 'ryokka',   label: '緑地・除草・剪定',    re: /除草|剪定|緑地|植栽|樹木|防除|駆除|外来種|外来植物/ },
  { slug: 'josetsu',  label: '除雪・雪対策',        re: /除雪|除排雪|排雪|雪寒|流雪/ },
  ...
  { slug: 'iryo',     label: '医療・健診・検査',    re: /医療|医薬品|薬品|検体|診療|健診|健康診断|検診|ワクチン|介護/ },
  ...
  { slug: 'chosa',    label: '調査・研究・分析',    re: /調査|研究|分析|試験|測定|実証|検討業務|モニタリング|監視事業|策定|推計|評価業務/ },
